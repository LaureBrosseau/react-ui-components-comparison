...
const rows = [
  {
    ...
    bryntum: '"The most reliable Web Components suite for Project Planning & Resource Management"',
  ...
  },
  {
    ...
    bryntum: 'Scheduling specialist',
    inhouse: 'Bespoke control',
  },
  {
    id: 3,
  ...
  },
  {
    ...
    inhouse: '$0 license — hidden cost: dev time + maintenance',
  },
  {
    id: 5,
    dimension: 'SaaS / Commercial',
  ...
  },
  {
    ...
    mui: 'Frontend devs → Tech Lead → CTO (multi-product orgs)',
    ag: 'Frontend devs → VP Engineering (data-heavy apps)',
    bryntum: 'Frontend devs → CPO (planning/scheduling tools)',
    inhouse: 'CTO / VP Engineering',
  },
  {
    id: 7,
    dimension: 'Ideal Use Cases',
    mui: 'Dashboards, SaaS B2B, CRUD apps, multi-team design systems',
    ag: 'Trading platforms, analytics, massive datasets, pivot tables',
    bryntum: 'Gantt charts, resource scheduling, ERP planning modules',
    inhouse: 'When UI component IS the core product differentiator',
  },
  {
    id: 8,
    dimension: 'Wins when',
    mui: 'Existing MUI stack, multi-team standardization, TCO matters',
    ag: 'Raw performance, pivoting, 100k+ rows client-side',
    bryntum: 'Scheduling is core to the product, not just a feature',
    inhouse: 'Truly unique interaction model, no market alternative',
  },
  {
    id: 9,
    ...
    bryntum: 'Use case is generic (CRUD/dashboard) or SaaS (OEM friction)',
  ...
  },
  {
    ...
    ag: 'Financial services, trading desks (performance-critical apps)',
